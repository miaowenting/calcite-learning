package com.matty.flink.sql.converter.type;
    ...
    public static final class Resolution {
        ...
        static {
            addResolutionMapping(
                    ...
                    (p1, p2) -> new YearMonthIntervalType(YearMonthIntervalType.YearMonthResolution.YEAR, p1));
            addResolutionMapping(
                    IntervalUnit.MONTH, null,
                    (p1, p2) -> new YearMonthIntervalType(YearMonthIntervalType.YearMonthResolution.MONTH));
            addResolutionMapping(
                    IntervalUnit.YEAR, IntervalUnit.MONTH,
                    (p1, p2) -> new YearMonthIntervalType(YearMonthIntervalType.YearMonthResolution.YEAR_TO_MONTH, p1));
            addResolutionMapping(
                    IntervalUnit.DAY, null,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.DAY, p1, DayTimeIntervalType.DEFAULT_FRACTIONAL_PRECISION));
            addResolutionMapping(
                    IntervalUnit.DAY, IntervalUnit.HOUR,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.DAY_TO_HOUR, p1, DayTimeIntervalType.DEFAULT_FRACTIONAL_PRECISION));
            addResolutionMapping(
                    IntervalUnit.DAY, IntervalUnit.MINUTE,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.DAY_TO_MINUTE, p1, DayTimeIntervalType.DEFAULT_FRACTIONAL_PRECISION));
            addResolutionMapping(
                    IntervalUnit.DAY, IntervalUnit.SECOND,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.DAY_TO_SECOND, p1, p2));
            addResolutionMapping(
                    IntervalUnit.HOUR, null,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.HOUR));
            addResolutionMapping(
                    IntervalUnit.HOUR, IntervalUnit.MINUTE,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.HOUR_TO_MINUTE));
            addResolutionMapping(
                    IntervalUnit.HOUR, IntervalUnit.SECOND,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.HOUR_TO_SECOND, DayTimeIntervalType.DEFAULT_DAY_PRECISION, p2));
            addResolutionMapping(
                    IntervalUnit.MINUTE, null,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.MINUTE));
            addResolutionMapping(
                    IntervalUnit.MINUTE, IntervalUnit.SECOND,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.MINUTE_TO_SECOND, DayTimeIntervalType.DEFAULT_DAY_PRECISION, p2));
            addResolutionMapping(
                    IntervalUnit.SECOND, null,
                    (p1, p2) -> new DayTimeIntervalType(DayTimeIntervalType.DayTimeResolution.SECOND, DayTimeIntervalType.DEFAULT_DAY_PRECISION, p1));
        }
