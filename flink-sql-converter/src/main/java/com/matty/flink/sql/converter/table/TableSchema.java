package com.matty.flink.sql.converter.table;
...
import static com.matty.flink.sql.converter.type.DataTypes.*;
import static com.matty.flink.sql.converter.type.util.TypeConversions.fromDataTypeToLegacyInfo;
import static com.matty.flink.sql.converter.type.util.TypeConversions.fromLegacyInfoToDataType;
...
public class TableSchema {
    ...
    /**
     * @deprecated Use the {@link TableSchema.Builder} instead.
     */
    @Deprecated
    ...
    public static class Builder {
         ...
         */
        @Deprecated
        public TableSchema.Builder field(String name, TypeInformation<?> typeInfo) {
