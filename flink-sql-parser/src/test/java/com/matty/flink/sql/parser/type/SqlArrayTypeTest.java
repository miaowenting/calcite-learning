 ...
 * @date 2019-11-11
 */
public class SqlArrayTypeTest extends BaseParser {
    private final static Logger LOG = LoggerFactory.getLogger(SqlArrayTypeTest.class);

    @Test
    public void createKafkaSourceWithArrayType() {
        String sql =
                " CREATE TABLE table_source(\n" +
                        "    name varchar,\n" +
                        "    channel string,\n" +
                        "    a array<int not null>,\n" +
                        "    pv int,\n" +
                        "    xctime bigint\n" +
                        " )WITH(\n" +
                        "    type='kafka11',\n" +
